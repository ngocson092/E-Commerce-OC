...
class ControllerModuleDQuickcheckout extends Controller {
    ...
    public function initialize(){
        ...
        $data['account']['guest']['payment_address']['fields']['telephone']['require'] = 1;

        $data['account']['guest']['payment_address']['fields']['lastname']['display'] = 0;
        $data['account']['guest']['payment_address']['fields']['lastname']['require'] = 0;

        $data['account']['guest']['payment_address']['fields']['fax']['display'] = 0;
        $data['account']['guest']['payment_address']['fields']['fax']['require'] = 0;

        $data['account']['guest']['payment_address']['fields']['agree']['display'] = 0;
        $data['account']['guest']['payment_address']['fields']['agree']['require'] = 0;

        $data['account']['guest']['payment_address']['fields']['company']['display'] = 0;
        $data['account']['guest']['payment_address']['fields']['company']['require'] = 0;
        ...
        $data['account']['guest']['cart']['option']['coupon']['display'] = 0;
        $data['account']['guest']['cart']['option']['voucher']['display'] = 0;
        $data['account']['guest']['cart']['option']['reward']['display'] = 0;
        ...
        $data['account']['guest']['confirm']['fields']['agree']['display'] = 0;


        $data['account']['guest']['shipping_method']['column'] = 2;
        $data['account']['guest']['payment_method']['column'] = 2;

        $data['design']['column_width'][1]  = 5;
        $data['design']['column_width'][2]  = 5;
        $data['design']['column_width'][3]  = 5;
