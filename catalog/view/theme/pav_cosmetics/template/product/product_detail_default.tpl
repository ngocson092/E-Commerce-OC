...
<div class="product-info">    
  ...
  <div class="product-view col-xs-12 col-sm-5 col-md-5 col-lg-5">
...
<div class="clearfix product-box-bottom tabs-group">
    <div id="tabs" class="htabs">
        <ul class="nav clearfix">
            ...
            <?php } ?>
            <?php if ( $productConfig['enable_product_customtab'] ) { ?>
                <li><a href="#tab-customtab1" data-toggle="tab"><?php echo $productConfig['product_customtab_name'][$languageID]; ?></a></li>
            <?php } ?>
        </ul>
    </div>
    <div class="tab-content box-content">
        ...
        <?php if ( $productConfig['enable_product_customtab'] ) { ?>
        <div class="tab-pane" id="tab-customtab1">
            <div class="inner">
