...
<div id="payment_address_wrap" <?php echo (!$payment_address['display']) ? 'class="qc-hide"' : ''; ?>>
  <div class="box box-border">
    <div class="box-heading">
      <span class="wrap"><i class="icon-profile"></i></span> 
      <span><?php echo $payment_address['title']; ?></span>
    </div>
    <div class="box-content">
      ...
      <div id="payment_address_exists_list" <?php echo (!$payment_address['exists']) ?  'class="qc-hide"' : ''; ?>>
