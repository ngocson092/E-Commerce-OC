...
<div id="shipping_address_wrap" <?php echo (!$shipping_display) ? 'class="qc-hide"' : ''; ?>>
  <div class="box box-border">
    <div class="box-heading">
      <span class="wrap"><i class="icon-shipping-address"></i></span> 
      <span><?php echo $shipping_address['title']; ?></span>
    </div>
    <div class="box-content">
      ...
      <?php if ($this->customer->isLogged()) { ?>
        ...
        <?php }else{ ?>
          ...
          <div id="shipping_address_exists_list" <?php echo (!$shipping_address['exists']) ?  'class="qc-hide"' : ''; ?>>
