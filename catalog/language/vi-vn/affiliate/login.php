...
$_['error_attempts']                = 'Thông báo: Tài khoản của bạn đã đăng nhập sai quá số lần cho phép. Vui lòng đăng nhập lại sau 1 giờ nữa.';
$_['error_approved']                = 'Thông báo: Tài khaonr của bạn cần được xét duyệt trước khi bạn đăng nhâp.';